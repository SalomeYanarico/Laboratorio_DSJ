...
{
    [Header("Spawn Setup")]
    [SerializeField] private FlockUnit[] flockUnitPrefabs; // CAMBIADO: ahora es un array
    ...
    private void GenerateUnits()
    {
        ...
        for (int i = 0; i < flockSize; i++)
        {
            ...
            // CAMBIADO: elegir prefab aleatorio
            var prefabToSpawn = flockUnitPrefabs[UnityEngine.Random.Range(0, flockUnitPrefabs.Length)];
            allUnits[i] = Instantiate(prefabToSpawn, spawnPosition, rotation);
